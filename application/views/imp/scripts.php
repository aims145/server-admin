...
<style type="text/css">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Important Scritps</h1>
        </div>
    ...
    <div class="row">
    <div class="col-lg-4">
    <a href="#addscript" data-toggle="modal" class="btn btn-primary ">Add Scripts</a>
    </div>
...
<a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $cmds->id;  ?>"><?php echo $cmds->title;  ?></a>
    ...
    <a class="btn btn-primary pull-right" onclick="downloadfile('<?php echo $cmds->id;  ?>')">Download as Text</a>		
              ...
              <pre class="<?php echo $cmds->id;?>"><?php echo $cmds->script; ?></pre>
          </div>
      </div>
    </div>
        </div>
    ...
    <div class="modal fade" id="addscript">
        <div class="modal-dialog" style="width: 75%;">
            <div class="modal-content">
                <form role="form" action="<?php echo base_url();?>server/imp/addscript" method="post" class="form-horizontal">
            ...
            <div class="modal-body">
                ...
                <div class=" form-group">
                    <label for="scriptname" class=" control-label col-lg-3">Script Title</label>
                    <div class=" col-lg-8">
                        <input type="text" class="form-control" name="scriptname" placeholder="Script Title" required>
                    </div>
                </div>
